...
JMETER=/opt/jmeter
PATH=$PATH:$SCALA_HOME/bin:$GROOVY_HOME/bin:$ANT_HOME/bin:$M2_HOME/bin:$GRADLE_HOME/bin:$VISUALVM/bin:$JMETER/bin
export PATH SCALA_HOME GROOVY_HOME ANT_HOME M2_HOME GRADLE_HOME VISUALVM JMETER
```
...
chsh -s $(which zsh)
# 配置 ohmyzsh 插件
git clone git://github.com/zsh-users/zsh-autosuggestions.git ~/.oh-my-zsh/plugins
